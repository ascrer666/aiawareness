...
$catalogs = [
	'en_US' => [
		...
		'Yapay zekâ ile makale özeti' => 'AI article summary',
		'Bu içeriği yapay zekâ ile özetle' => 'Summarize this article with AI',
		'Bu makaleyi özetle ve yalnızca güvenilir kaynakları kullan: %s' => 'Summarize this article and use only reliable sources: %s',
		'(yeni pencerede açılır)' => '(opens in a new window)',
		'Google’da tercih edilen kaynak' => 'Preferred source on Google',
		'Google tercih edilen kaynak düğmesini göster' => 'Show the Google Preferred Source button',
		'Özet çubuğunun üstünde veya altında, Google’ın kendi yerelleştirilmiş düğmesini gösterir. Google publisher betiği tema veya başka bir eklenti tarafından zaten yüklenmiş olmalıdır.' => 'Shows Google’s own localized button above or below the summary bar. The Google publisher script must already be loaded by the theme or another plugin.',
		'Google düğmesi konumu' => 'Google button position',
		'Özet çubuğunun üstünde' => 'Above the summary bar',
		'Özet çubuğunun altında' => 'Below the summary bar',
	...
	'de_DE' => [
		...
		'Yapay zekâ ile makale özeti' => 'KI-Zusammenfassung des Artikels',
		'Bu içeriği yapay zekâ ile özetle' => 'Diesen Artikel mit KI zusammenfassen',
		'Bu makaleyi özetle ve yalnızca güvenilir kaynakları kullan: %s' => 'Fasse diesen Artikel zusammen und verwende nur zuverlässige Quellen: %s',
		'(yeni pencerede açılır)' => '(öffnet in einem neuen Fenster)',
		'Google’da tercih edilen kaynak' => 'Bevorzugte Quelle bei Google',
		'Google tercih edilen kaynak düğmesini göster' => 'Google-Schaltfläche für bevorzugte Quellen anzeigen',
		'Özet çubuğunun üstünde veya altında, Google’ın kendi yerelleştirilmiş düğmesini gösterir. Google publisher betiği tema veya başka bir eklenti tarafından zaten yüklenmiş olmalıdır.' => 'Zeigt die von Google lokalisierte Schaltfläche über oder unter der Zusammenfassungsleiste. Das Google-Publisher-Skript muss bereits durch das Theme oder ein anderes Plugin geladen sein.',
		'Google düğmesi konumu' => 'Position der Google-Schaltfläche',
		'Özet çubuğunun üstünde' => 'Über der Zusammenfassungsleiste',
		'Özet çubuğunun altında' => 'Unter der Zusammenfassungsleiste',
	...
	'fr_FR' => [
		...
		'Yapay zekâ ile makale özeti' => 'Résumé de l’article par IA',
		'Bu içeriği yapay zekâ ile özetle' => 'Résumer cet article avec l’IA',
		'Bu makaleyi özetle ve yalnızca güvenilir kaynakları kullan: %s' => 'Résumez cet article en utilisant uniquement des sources fiables : %s',
		'(yeni pencerede açılır)' => '(s’ouvre dans une nouvelle fenêtre)',
		'Google’da tercih edilen kaynak' => 'Source préférée sur Google',
		'Google tercih edilen kaynak düğmesini göster' => 'Afficher le bouton Google des sources préférées',
		'Özet çubuğunun üstünde veya altında, Google’ın kendi yerelleştirilmiş düğmesini gösterir. Google publisher betiği tema veya başka bir eklenti tarafından zaten yüklenmiş olmalıdır.' => 'Affiche le bouton Google localisé au-dessus ou au-dessous de la barre de résumé. Le script Google Publisher doit déjà être chargé par le thème ou une autre extension.',
		'Google düğmesi konumu' => 'Position du bouton Google',
		'Özet çubuğunun üstünde' => 'Au-dessus de la barre de résumé',
		'Özet çubuğunun altında' => 'Sous la barre de résumé',
	...
	'ru_RU' => [
		...
		'Yapay zekâ ile makale özeti' => 'ИИ-резюме статьи',
		'Bu içeriği yapay zekâ ile özetle' => 'Кратко изложить эту статью с помощью ИИ',
		'Bu makaleyi özetle ve yalnızca güvenilir kaynakları kullan: %s' => 'Кратко изложите эту статью, используя только надежные источники: %s',
		'(yeni pencerede açılır)' => '(открывается в новом окне)',
		'Google’da tercih edilen kaynak' => 'Предпочтительный источник в Google',
		'Google tercih edilen kaynak düğmesini göster' => 'Показывать кнопку Google для предпочтительных источников',
		'Özet çubuğunun üstünde veya altında, Google’ın kendi yerelleştirilmiş düğmesini gösterir. Google publisher betiği tema veya başka bir eklenti tarafından zaten yüklenmiş olmalıdır.' => 'Показывает локализованную кнопку Google над или под панелью резюме. Скрипт Google Publisher должен быть уже загружен темой или другим плагином.',
		'Google düğmesi konumu' => 'Расположение кнопки Google',
		'Özet çubuğunun üstünde' => 'Над панелью резюме',
		'Özet çubuğunun altında' => 'Под панелью резюме',
